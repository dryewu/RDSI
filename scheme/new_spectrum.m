function new_spectrum()
    adc_restricted = [];
    adc_hindered = [];
    adc_isotropic = (0.1e-3 : 0.1e-3 : 3e-3)';

    for adc_long_diff = 1e-3 : 0.15e-3 : 2e-3
        for adc_trans_diff = 0e-3 : 0.15e-3 : 2e-3
    ...
    save('new_spectrum.mat','adc_restricted','num_restricted',...
