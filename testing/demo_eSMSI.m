...
ME_eSMSI(fdwi,fbval,fmask,TE,fullfile(dataFolder,'ME_eSMSI'));

clear all; clc;
dataFolder = '/home/wuye/D_disk/MTE_dMRI/XYQ/proc';
fdwi    = fullfile(dataFolder,'DKI_PA_align_center_denoise_unring_preproc_epi_unbiased2_in_T1.nii.gz');
fbval   = fullfile(dataFolder,'DKI_PA_align_center_denoise_unring_preproc_epi_unbiased2_in_T1.bval');
fmask   = fullfile(dataFolder,'MTE_mask.nii.gz');
SE_eSMSI(fdwi,fbval,fmask,fullfile(dataFolder,'SE_eSMSI'));
