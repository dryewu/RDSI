...
ft2r    = fullfile(dataFolder,'ME_SMSIx_ROI_default','T2.nii.gz');
fmasvk   = fullfile(dataFolder,'MTE_mask_ROI.nii.gz');
ME_SMSIx(fdwi,fbval,fmask,TE,fullfile(dataFolder,'ME_SMSIx_ROI_default'));
ME_SIx(fdwi,fbvec,fbval,ft2r,fmask,TE,fullfile(dataFolder,'ME_SIx_ROI_default'));
ME_SIx(fdwi,fbvec,fbval,ft2r,fmask,TE,fullfile(dataFolder,'ME_SIx_ROI_default'));