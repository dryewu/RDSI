...
TE = [75 85 95 105 115];
mkdir(fullfile(dataFolder,'SE_SMSI_default'))
...
for i = 1:length(TE)
    ...
    SE_SMSI(fdwi,fbval,fmask,fullfile(dataFolder,'SE_SMSI_default',num2str(TE(i))));
    SE_SMSI(fdwi,fbval,fmask,fullfile(dataFolder,'SE_SMSI',num2str(TE(i))),spectrum='scheme/new_spectrum.mat');
end
